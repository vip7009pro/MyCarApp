...
const val CHANNEL_ID = "hn.page.mycarapp.CHANNEL_ID"
const val READ_ACTION = "hn.page.mycarapp.ACTION_MESSAGE_READ"
const val REPLY_ACTION = "hn.page.mycarapp.ACTION_MESSAGE_REPLY"
    ...
    private fun sendNotification(
        ...
        if (hasPostNotifications) {
            try {
                ...
                // Ignore; notification permission can be revoked at runtime.
            }
        }
    }
